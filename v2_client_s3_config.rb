      ...
      #  puts file
        ...
        Zip::ZipFile.open("./server_applications/#{file}") { |zipfile|
            ...
            s3_client.get_object(
                response_target: "/home/niharika/Desktop/ClientServer/server_applications/#{file}",
        ...
        s3_client.put_object(bucket: guid, key: filename, body: File.open("/home/niharika/Desktop/ClientServer/server_applications/#{file}"))
